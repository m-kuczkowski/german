...
describe("relational learning API mappers", () => {
  it("preserves the existing catalog response shape", () => {
    expect(mapCatalogRow({
      ...
      word_family_id: "wohnung",
      word_family_role: "compound",
      prerequisite_ids: ["wohnung-base"],
      word_parts: [
        { german: "Wohnung", polish: "mieszkanie" },
        { german: "Markt", polish: "rynek" },
      ],
      level: "A2",
      ...
      category: "Dom i mieszkanie (Wohnen und Haushalt)",
      curriculumTier: "core",
      wordFamilyId: "wohnung",
      wordFamilyRole: "compound",
      prerequisiteIds: ["wohnung-base"],
      wordParts: [
        { german: "Wohnung", polish: "mieszkanie" },
        { german: "Markt", polish: "rynek" },
      ],
